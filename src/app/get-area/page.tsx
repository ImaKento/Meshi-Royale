...
import { Container, Stack, Box, Typography, Button, Alert, Paper, Grid, FormControl, InputLabel, Select as MUISelect, MenuItem, LinearProgress, List, ListItem, Divider, Chip, Link, AlertTitle, ListItemButton } from "@mui/material";
                      ...
                      >
                        ...
                        <Box sx={{ minWidth: 0, flex: 1 }}>
                          <Stack direction="row" alignItems="center" justifyContent="space-between" gap={2}>
                            ...
                            {s.distance != null && (
                              <Chip size="small" label={`${(s.distance / 1000).toFixed(2)} km`} variant="outlined" />
                            )}
                          </Stack>
                          <Typography variant="body2" color="text.secondary" noWrap>
                            {s.genre ? `${s.genre}・` : ""}{s.address}
                          </Typography>
                          {s.access && (
